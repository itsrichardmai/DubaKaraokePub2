            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-yellow-400/10 to-transparent border border-yellow-500/30 rounded-lg p-8">
                ...
                <div className="flex gap-4 mb-6">
                  <a href="https://www.facebook.com/Dubakaraokepub/" className="bg-black/50 hover:bg-yellow-400 text-white hover:text-black p-3 rounded-full transition-all">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                    </svg>
                  </a>
                  <a href="https://www.instagram.com/dubakaraokepub/" className="bg-black/50 hover:bg-yellow-400 text-white hover:text-black p-3 rounded-full transition-all">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="space-y-3">
                  <a 
                    href="https://www.grubhub.com/restaurant/duba-karaoke--pub-1333-west-cheltenham-avenue-elkins-park/4012912?msockid=28513a81fc7866be23762c0bfd476761" 
                    target="_blank"
                  ...
                  <a 
                    href="https://www.ubereats.com/store/duba-karaoke-and-pub/CieG1UYxV02VonuZ5drsJw?diningMode=DELIVERY&sc=SEARCH_SUGGESTION" 
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a 
                    href="https://www.doordash.com/store/duba-karaoke-&-pub-elkins-park-22973432/12782885/?msockid=28513a81fc7866be23762c0bfd476761" 
                    target="_blank"
                    rel="noopener noreferrer"
